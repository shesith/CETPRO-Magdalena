import hostel from "../assets/ciclo-basico-7.png";
    ...
    <section className="backdrop">
      <article className="container">
        <div className="content-img-craft">
          <img src={hostel} alt="artesania" />
        </div>
        <div>
          <h2 className="blue">Servicios Personales y de Hogares</h2>
          ...
          <div className="content-img-craft-2">
            <div>
              <img src={cap6} alt="cursos" />
            </div>
            <div>
              <h2 className="blue">Horarios:</h2>
              <img src={cap7} alt="horarios" />
            </div>
          </div>
