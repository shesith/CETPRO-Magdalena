import estetica from "../assets/ciclo-basico-6.png";
    ...
    <section className="backdrop">
      <article className="container">
        <div className="content-img-craft">
          <img src={estetica} alt="artesania" />
        </div>
        <div>
          <h2 className="blue">Estética Personal</h2>
          ...
          <div className="content-img-craft-2">
            <div>
              <img src={cap4} alt="cursos" />
            </div>
            <div>
              <h2 className="blue">Horarios:</h2>
              <img src={cap5} alt="horarios" />
            </div>
          </div>
