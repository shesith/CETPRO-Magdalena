    ...
    <section className="backdrop">
      <article className="container">
        <div className="content-img-craft">
          <img src={GetImageUrl("ciclo-basico-5")} alt="artesania" />
        </div>
        <div>
          <h2 className="blue">Computación e Informática</h2>
          ...
          <div className="content-img-craft-2">
            <div>
              <img src={GetImageUrl("cap2")} alt="cursos" />
            </div>
            <div>
              <h2 className="blue">Horarios:</h2>
              <img src={GetImageUrl("cap3")} alt="horarios" />
            </div>
          </div>
